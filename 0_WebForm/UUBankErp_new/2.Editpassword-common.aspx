<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="2.Editpassword-common.aspx.cs" Inherits="_2_Editpassword" %>
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5" style="background-color: #ffffff">
                            ...
                            <div class="pt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="請填舊密碼" Text="請填舊密碼" ControlToValidate="OldPassword" CssClass="badge badge-outline-danger badge-pill"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-block btn-secondary btn-lg font-weight-medium auth-form-btn " NavigateUrl="~/2.EditSlefPerson-Common.aspx">返回</asp:HyperLink>
                                    </div>
                                </div>
