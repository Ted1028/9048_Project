<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="2.EditSlefPerson-Hight.aspx.cs" Inherits="EditSlefPerson" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card-body" id="mytable">
        <h1 class="card-title">
            <asp:Label runat="server" Text="" Font-Size="XX-Large" ID="lblHello" ForeColor="#625D5D"></asp:Label>
        </h1>
        ...
        <div class="row">
            <div class="col-4">
                <ul class="nav nav-pills nav-pills-vertical nav-pills-info" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="Authority" data-bs-toggle="pill" href="#AuthorityInfo" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                            <i class="ti-key"></i>
                            人事功能
                        </a>
                    </li>
            ...
            <div class="col-8">
                <div class="tab-content tab-content-vertical" id="v-pills-tabContent">
                                ...
                                <div class="card-body">
                                    <div class="wrapper text-center">
                                        ...
                                        <div>
                                            ...
                                            <asp:HyperLink ID="EditPassword" runat="server" NavigateUrl="~/2.editpassword.aspx" CssClass="btn btn-inverse-warning auth-link text-black col-10" Font-Size="Small">密碼變更</asp:HyperLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="AuthorityInfo" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <div class="media">
                            <div class="media-body col-3">
                                <div class="card-body">
                                    <div class=" text-center">
                                        <h4 class="wrapper card-title">
                                            <asp:Label ID="lblSearch" runat="server" Text="員工資料查詢" CssClass="fa fa-search cc" for="SearchInfo" ForeColor="#625D5D"></asp:Label>
                                        </h4>
                                        <p class="card-description">
                                            <asp:LinkButton ID="lbtnSearch" runat="server" CssClass="btn btn-warning card-description" PostBackUrl="~/2.EmployeeList OnlySearch.aspx">查詢</asp:LinkButton>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="media-body  col-3">
                                <div class="card-body">
                                    <div class="wrapper text-center">
                                        <h4 class="card-title">
                                            <asp:Label ID="lblEmployeeAdd" runat="server" Text="員工資料新增" CssClass="fa fa-plus cc" for="SearchInfo" ForeColor="#625D5D"></asp:Label>
                                        </h4>
                                        <p class="card-description">
                                            <asp:LinkButton ID="lbtnEmployeeAdd" runat="server" CssClass="btn btn-warning card-description" PostBackUrl="~/2.EmployeeAdd.aspx">新增</asp:LinkButton>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="media-body col-3 ">
                                <div class="card-body">
                                    <div class="wrapper text-center">
                                        <h4 class="card-title">
                                            <asp:Label ID="lblEditDelete" runat="server" Text="員工資料編輯" CssClass="fa fa-edit cc" for="SearchInfo" ForeColor="#625D5D"></asp:Label>
                                        </h4>
                                        <p class="card-description">
                                            <asp:LinkButton ID="lbtnEditDelete" runat="server" CssClass="btn btn-warning card-description" PostBackUrl="~/2.EmployeeList.aspx" >編輯</asp:LinkButton>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="media-body col-3">
                                <div class="card-body">
                                    <div class="wrapper text-center">
                                        <h4 class="card-title">
                                            <asp:Label ID="lbllbtnEditAu" runat="server" Text="員工權限修改" CssClass="fa fa-edit cc" for="SearchInfo" ForeColor="#625D5D"></asp:Label>
                                        </h4>
                                        <p class="card-description">
                                            <asp:LinkButton ID="lbtnEditAu" runat="server" CssClass="btn btn-warning card-description" PostBackUrl="~/2.AuthoritySearch.aspx">編輯</asp:LinkButton>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="logoutInfo" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        ...
                        <div class="card-body">
                            <div class=" text-center">
                                <h4 class="wrapper card-title">
                                    <asp:Label ID="Label4" runat="server" Text="人事系統登出" CssClass="fa fa-sign-out cc" for="SearchInfo" ForeColor="#625D5D"></asp:Label>
                                </h4>
                                <p class="card-description">
