...
/// <summary>
/// Summary description for TemporaryClub
/// </summary>
public class TemporaryClub
{
    public TemporaryClub(int id2, string clubName2, int clubFounderId2, string clubFounderName2, string clubScript2, string detailClubScript2, int peopleCount2, string clubImage2, bool approve2)
    {
        Id2 = id2;
        ClubName2 = clubName2;
