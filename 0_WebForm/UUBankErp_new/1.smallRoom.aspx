<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="1.smallRoom.aspx.cs" Inherits="_1_meetingRoom" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-sample">
                            ...
                            <asp:Button ID="Button1" runat="server" Text="確認申請" CssClass="btn btn-success btn-lg" OnClick="Button1_Click" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="scriptHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        (function ($) {
            $.ajax({
                type: 'POST',
                url: "WebService.asmx/GetAllSmallMeeting",
